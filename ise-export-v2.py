#!/usr/bin/env python3
"""
Usage: ./ise-export-v2.py [environment]
...
Note: This script is designed to run as a cron job, uses environment variables from .env file, 
and supports multiple ISE environments.
